...
- Native Plaid bank-feed matching and native Stripe customer/contract/AR reconciliation, including
  fee-bearing payout components and payout-to-bank-to-posted-cash proof without duplicate journals
