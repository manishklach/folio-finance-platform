...
| 15. External integrations            | Active   | Provider adapters/worker plus native Plaid, Stripe AR/payment/payout, and Gusto accrual/liability/cash reconciliation shipped; OAuth, CRM native handoff and sandbox evidence remain |
...
- First-administrator setup requires a one-time secret-file token and a recorded, network-restricted
  production ceremony.
