...
| 15. External integrations            | Active   | Provider adapters/worker plus native Plaid and Stripe AR/payment/payout reconciliation shipped; OAuth, payroll/CRM native handoffs and sandbox evidence remain |
