...
| Integration/import ops    | Active             | connector worker, provider-to-draft approval, native Plaid feed/matching, durable imports, correction/fuzzy review and 10k gate shipped; other native subledgers and sandbox/deployed soak remain |
