...
| Integration/import ops    | Pending            | live connectors, mapping, replay-safe sync and exception workbench required             |
| Production operations     | Pending            | hosting, SLO, alerts, off-site restore and rollback exercises required                  |
