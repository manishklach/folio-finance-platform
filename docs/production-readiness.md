...
| Integration/import ops    | Active             | connector/run foundation and guided file/mapping/preview workbench shipped; live provider authorization, sandbox and scale evidence remain |
