...
| Integration/import ops    | Active             | connector worker, provider-to-draft approval, durable imports, correction/fuzzy review and 10k gate shipped; native provider subledgers, sandbox/deployed soak remain |
