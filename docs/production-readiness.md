...
| Integration/import ops    | Active             | native Plaid, Stripe, Gusto and HubSpot handoffs plus hosted OAuth for Stripe/Gusto/HubSpot, durable imports and 10k gate shipped; Plaid Link, webhook completion and provider sandbox/deployed soak remain |
